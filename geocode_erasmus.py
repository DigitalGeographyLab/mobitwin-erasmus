...
locations.to_csv(args['output'] + 'erasmus_pre-geocoded_locations_only.csv', encoding='utf-8', sep=';')
...
for i, row in locations.iterrows():
    if n_iter != 20:
        ...
        # save progress
        locations.to_pickle(args['output'] + 'geocoded_locations_intermediate.pkl')
...
for i, row in unloc.iterrows():
    if n_iter != 25:
        ...
        # save progress
        unloc.to_pickle(args['output'] + 'geocoded_fixed_locations_intermediate.pkl')
...
for i, row in up_unsuc_errors.iterrows():
    if n_iter != 25:
        ...
        # save progress
        up_unsuc_errors.to_pickle(args['output'] + 'geocoded_fixed_nominatims_locations_intermediate.pkl')
...
result.to_file(args['output'] + 'geocoded_erasmus_placenames_finla.gpkg', driver='GPKG')
